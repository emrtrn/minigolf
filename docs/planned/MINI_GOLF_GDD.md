...
> vizyonunu, oynanışını, fizik modelini, kapsamını ve gereken Forge platform
> işini tanımlamak.
> Kaynak: Fikir havuzu [`KENNEY_GAME_IDEAS.md`](./KENNEY_GAME_IDEAS.md) (#31, ilk
...
- Bu GDD Forge `docs/planned/` altında durur çünkü hem ilk-oyun planını hem de
